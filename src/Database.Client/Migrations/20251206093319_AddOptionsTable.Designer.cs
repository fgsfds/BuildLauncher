...
namespace Database.Client.Migrations
{
    ...
    [Migration("20251206093319_AddOptionsTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Database.Client.DbEntities.FavoritesDbEntity", b =>
                {
                    b.Property<string>("AddonId")
                        .HasColumnType("TEXT")
                        .HasColumnName("addon_id");
                    ...
                    b.Property<string>("Version")
                        .HasColumnType("TEXT")
                        .HasColumnName("addon_version");

                    b.HasKey("AddonId", "Version");

                    b.ToTable("favorite_addons", "main");
                });
            ...
            modelBuilder.Entity("Database.Client.DbEntities.OptionsDbEntity", b =>
                {
                    b.Property<string>("AddonId")
                        .HasColumnType("TEXT")
                        .HasColumnName("addon_id");

                    b.Property<string>("EnabledOptions")
                        .IsRequired()
                        .HasColumnType("TEXT")
                        .HasColumnName("enabled_options");

                    b.HasKey("AddonId");

                    b.ToTable("addon_options", "main");
                });
