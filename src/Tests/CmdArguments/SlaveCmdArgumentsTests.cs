...
public sealed class SlaveCmdArgumentsTests
{
    ...
    public void RazeTest()
    {
        ...
        var expected = @$" -quick -nosetup -file ""enabled_mod.zip"" -adddef ""ENABLED1.DEF"" -adddef ""ENABLED2.DEF"" -savedir ""{Directory.GetCurrentDirectory()}\Data\Ports\Raze\Save\exhumed"" -def ""a""";
