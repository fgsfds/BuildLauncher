...
public sealed class AutoloadModsValidatorTests
{
        ...
        ImmutableArray<FeatureEnum>? requiredFeatures = null)
    {
        return new AutoloadMod
        {
            ...
            Title = id,
            SupportedGame = game,
            FileInfo = new AddonFilePathWrapper($"D:\\Mods\\{id}.zip", $"{id}.zip"),
        ...
        IReadOnlyDictionary<string, string?>? dependentAddons = null)
    {
        return new AutoloadMod
        {
            ...
            Title = id,
            SupportedGame = game,
            FileInfo = new AddonFilePathWrapper($"D:\\Campaigns\\{id}.zip", $"{id}.zip"),
            DependentAddons = dependentAddons,
            IncompatibleAddons = incompatibleAddons,
    ...
    {
        var mod = CreateMod(
            "featureMod", "1.0", DukeGame, requiredFeatures:
            [
                FeatureEnum.Models,
    ...
    public void ValidateAutoloadMod_CampaignIncompatibleWildcard_ReturnsFalse()
    {
        ...
        var campaign = CreateCampaign(
            "campaign", "1.0", DukeGame, incompatibleAddons: new Dictionary<string, string?>
            {
                {
                    "*", null
                }
    ...
    {
        var mod = CreateMod(
            "dependentMod", "1.0", DukeGame, dependentAddons: new Dictionary<string, string?>
            {
                {
                    "campaign", null
                }
    ...
    public void ValidateAutoloadMod_DependencyOnCampaignDependentAddon_ReturnTrue()
    {
        ...
        var campaign = CreateCampaign(
            "campaign", "1.0", DukeGame, dependentAddons: new Dictionary<string, string?>
            {
                {
                    "someAddon", "1.0"
                }
    ...
    {
        var mod = CreateMod(
            "needyMod", "1.0", DukeGame, dependentAddons: new Dictionary<string, string?>
            {
                {
                    "missingMod", null
                }
    ...
    {
        var mod = CreateMod(
            "conflictingMod", "1.0", DukeGame, incompatibleAddons: new Dictionary<string, string?>
            {
                {
                    "campaign", null
                }
