...
public sealed class ConfigProvider : IConfigProvider
{
    ...
    public void ChangeModState(AddonId addonId, bool isEnabled)
    {
        ...
        if (existing is null)
        {
            ...
            {
                _ = dbContext.DisabledAddons.Add(
                    new()
                    {
                        AddonId = addonId.Id
                    }
