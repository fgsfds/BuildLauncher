...
public sealed partial class RightPanelControl : UserControl
{
    ...
    private void Button_PointerEntered1(object? sender, Avalonia.Input.PointerEventArgs e)
    {
        Star1.Content = "★";
        Star2.Content = "☆";
        Star3.Content = "☆";
    ...
    private void Button_PointerEntered2(object? sender, Avalonia.Input.PointerEventArgs e)
    {
        Star1.Content = "★";
        Star2.Content = "★";
        Star3.Content = "☆";
    ...
    private void Button_PointerEntered3(object? sender, Avalonia.Input.PointerEventArgs e)
    {
        Star1.Content = "★";
        Star2.Content = "★";
        Star3.Content = "★";
    ...
    private void Button_PointerEntered4(object? sender, Avalonia.Input.PointerEventArgs e)
    {
        Star1.Content = "★";
        Star2.Content = "★";
        Star3.Content = "★";
    ...
    private void Button_PointerEntered5(object? sender, Avalonia.Input.PointerEventArgs e)
    {
        Star1.Content = "★";
        Star2.Content = "★";
        Star3.Content = "★";
