...
public sealed partial class ModsViewModel : RightPanelViewModel, IPortsButtonControl
{
    ...
    /// </summary>
    public ImmutableList<AutoloadMod> ModsList => [.. _installedAddonsProvider.GetInstalledAddonsByType(AddonTypeEnum.Mod).Select(x => (AutoloadMod)x).OrderBy(static x => x.Title)];
